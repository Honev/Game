...
monogatari.script({
  ...
  Yes2: [
    ...
    'hide character sung happy at left',
    'show character sung normal at left',
    'sung 그런가요..',
    'uj 처음엔 장난인줄 알았어요.',
    'hide character sung normal at left',
    'show character sung sad at left',
    'sung 죄송합니다...',
    'hide character uj normal',
    'show character kim right at right',
    'kim 아이디어잖아요? 괜찮아요. 계속 진행해보죠.',
    'hide character kim right with end-fadeOut duration 2s',
    'hide character sung sad with end-fadeOut duration 2s',
    'jump normalEnd01',
  ],
  ...
  ep1Scene5: [
    ...
    'hide character kim left',
    'show character sm normal at left',
  ...
  No4: [
    ...
    'hide character sung smile',
    'show character jung happy at left',
    'jung 좋은 것 같아요.',
    'hide character uj happy',
    'hide character jung happy',
    'show scene url("assets/scenes/office_talking.png")',
    'show character sung happy',
    'sung ',
    'sung (힛)',
    'hide character sung happy with end-fadeOut duration 2s',
    'jump goodEnd01',
  ],
